...
![狂神redis笔记(下)_IT_04](https://s4.51cto.com/images/blog/202107/23/49e10bfbc1d1aa3cab27555ab8a07c54.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_IT_05](https://s4.51cto.com/images/blog/202107/23/11b1191080b3395ca9c84b82ecad6c88.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

如果文件正常，重启就可以直接恢复了！

![狂神redis笔记(下)_redis_06](https://s4.51cto.com/images/blog/202107/23/5fc863d414e160c6744fc8d046dacf46.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

> 重写规则说明

aof 默认就是文件的无限追加，文件会越来越大！

![狂神redis笔记(下)_redis_07](https://s4.51cto.com/images/blog/202107/23/a04288d4474dd0fb88d9fdede66a416d.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_redis_08](https://s4.51cto.com/images/blog/202107/23/9d17a3d805f92ed11bc8d8544e4e0432.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

下图展示了频道 channel1 ， 以及订阅这个频道的三个客户端 —— client2 、 client5 和 client1 之间的关系：

![狂神redis笔记(下)_IT_09](https://s4.51cto.com/images/blog/202107/23/f811fa7d991088d58c033ff9fa7fd94a.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：

![狂神redis笔记(下)_IT_10](https://s4.51cto.com/images/blog/202107/23/fc6ff25689489c19d705af26b80127c4.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

> 命令

这些命令被广泛用于构建即时通信应用，比如网络聊天室(chatroom)和实时广播、实时提醒等。

![狂神redis笔记(下)_IT_11](https://s4.51cto.com/images/blog/202107/23/066d7ae9553de15057962fbd047a534d.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

> redis测试消息订阅与发送：

1、在一个窗口注册频道

![狂神redis笔记(下)_IT_12](https://s4.51cto.com/images/blog/202107/23/2e04fe8c9c359a04fadf6697326aae00.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

2、在另外一个窗口连接到指定的频道，发送消息

![狂神redis笔记(下)_redis_13](https://s4.51cto.com/images/blog/202107/23/1fcc0c91e5350fce304d15a794c87406.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

3、频道1接收到消息

![狂神redis笔记(下)_redis_14](https://s4.51cto.com/images/blog/202107/23/fdd201b79285079d0febe5e722a90e70.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_IT_15](https://s4.51cto.com/images/blog/202107/23/8887749d80b3e1c701adc2475d89edcb.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_IT_16](https://s4.51cto.com/images/blog/202107/23/8e1102bae3263cd660458721854d180c.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_IT_17](https://s4.51cto.com/images/blog/202107/23/e9fd2a2027a0eade8e63074b54a920c6.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

复制3个配置文件：cp redis.config redis79.config...

![狂神redis笔记(下)_redis_18](https://s4.51cto.com/images/blog/202107/23/892e22bca1360744056ef58e2d2ad116.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

修改信息：

- 1、端口

![狂神redis笔记(下)_redis_19](https://s4.51cto.com/images/blog/202107/23/d5bc11dbdd1aa8fa677c0ef14fa84645.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

- 2、pid 名字

![狂神redis笔记(下)_IT_20](https://s4.51cto.com/images/blog/202107/23/0d649e9a7c05644e52f00c993d487296.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

- 3、log文件名字

![狂神redis笔记(下)_IT_21](https://s4.51cto.com/images/blog/202107/23/38ccfdb1e0148795e3b023317adcecd1.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

- 4、dump.rdb 名字

![狂神redis笔记(下)_redis_22](https://s4.51cto.com/images/blog/202107/23/15e11aa220fc39d481c0765b17ea6982.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

修改完毕之后，启动我们的3个redis服务器，可以通过进程信息查看！

![狂神redis笔记(下)_IT_23](https://s4.51cto.com/images/blog/202107/23/f046bd37cd83e92f2608e6c061f44b58.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_redis_24](https://s4.51cto.com/images/blog/202107/23/f2f30b0261f1e4cb0d773b55946c7878.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

 在主机中查看：

![狂神redis笔记(下)_IT_25](https://s4.51cto.com/images/blog/202107/23/c269b5ecec63d3857f5e1912b16ebb72.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

真实的从主配置应该在配置文件中配置，这样的话是永久的，我们这里使用的是命令，暂时的！

从机配置主机的信息：

![狂神redis笔记(下)_IT_26](https://s4.51cto.com/images/blog/202107/23/39974de26c49055671b51fac51eafa3b.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_IT_27](https://s4.51cto.com/images/blog/202107/23/ee60645fd4d9cff108581d1c3809e128.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

 从机只能读取，不能写入：

![狂神redis笔记(下)_IT_28](https://s4.51cto.com/images/blog/202107/23/addd333ada5861db239035227842f7c4.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_redis_29](https://s4.51cto.com/images/blog/202107/23/8dac6d7d68069cc81880365008f9e663.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_redis_30](https://s4.51cto.com/images/blog/202107/23/a81e9dd0caeffc6eb33d24763111ab07.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_IT_31](https://s4.51cto.com/images/blog/202107/23/48ae165619f56948da377b36934f3853.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
```bash
# sentinel monitor 哨兵名称 local post 1(表示有几个哨兵通过就让它称为老大)
  sentinel monitor myredis 182.92.209.212 6379 1
```

2、启动哨兵！

![狂神redis笔记(下)_redis_32](https://s4.51cto.com/images/blog/202107/23/5e1a3c865b9211762fa0a1ff3de2fbb3.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

![狂神redis笔记(下)_IT_33](https://s4.51cto.com/images/blog/202107/23/dbdbb314c95347997fdc8375db435cb4.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

如果Master 节点断开了，这个时候就会从从机中随机选择一个服务器！ （这里面有一个投票算法！）

![狂神redis笔记(下)_IT_34](https://s4.51cto.com/images/blog/202107/23/3addabef73d48b3c3eb277d4e6199f63.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

哨兵日志！

![狂神redis笔记(下)_IT_35](https://s4.51cto.com/images/blog/202107/23/de5f3da423f4887c8b67ba6df57b5a9d.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_redis_36](https://s4.51cto.com/images/blog/202107/23/46f151d26639a563bbd4ed68f65329ff.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

![狂神redis笔记(下)_IT_37](https://s4.51cto.com/images/blog/202107/23/d61784ecb18fdeb1a35c60f070b5242e.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

![狂神redis笔记(下)_redis_38](https://s4.51cto.com/images/blog/202107/23/40cefd07b1972a93d2fbe7bc1038eccf.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_IT_39](https://s4.51cto.com/images/blog/202107/23/79dbb1b47572a57bde4c4f1ee96f51a0.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_IT_40](https://s4.51cto.com/images/blog/202107/23/faab25005ffa2e9d220adf150d73b367.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)

 缓存空对象
当存储层不命中后，即使返回的空对象也将其缓存起来，同时会设置一个过期时间，之后再访问这个数据将会从缓存中获取，保护后端数据源。

![狂神redis笔记(下)_IT_42](https://s4.51cto.com/images/blog/202107/23/2de3fb782e65eeb0701349fbf0e7ee32.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
...
![狂神redis笔记(下)_redis_43](https://s4.51cto.com/images/blog/202107/23/214daa21f4ccd7fdafa4cfbcb67870ed.png?x-oss-process=image/watermark,size_16,text_QDUxQ1RP5Y2a5a6i,color_FFFFFF,t_100,g_se,x_10,y_10,shadow_90,type_ZmFuZ3poZW5naGVpdGk=)
