...
![在这里插入图片描述](24.JUC.assets/20210713151120463.png)
...
![在这里插入图片描述](24.JUC.assets/20210713151152523.png)
...
![在这里插入图片描述](24.JUC.assets/20210713164909902.png)

![在这里插入图片描述](24.JUC.assets/20210713164838682.png)
...
![在这里插入图片描述](24.JUC.assets/20200727200107238.png)
...
![在这里插入图片描述](24.JUC.assets/20200727200309313.png)
...
![在这里插入图片描述](24.JUC.assets/20200727200505228.png)
...
![在这里插入图片描述](24.JUC.assets/20200727200541706.png)
...
![在这里插入图片描述](24.JUC.assets/20200727200635437.png)
...
![在这里插入图片描述](24.JUC.assets/20200727200753229.png)
...
![在这里插入图片描述](24.JUC.assets/20200727200947247.png)
...
![在这里插入图片描述](24.JUC.assets/20200727201304983.png)
...
![在这里插入图片描述](24.JUC.assets/20200727201526105.png)

**CopyOnWriteArrayList**使用的是Lock锁，效率会更加高效！

![在这里插入图片描述](24.JUC.assets/20200727201546295.png)

### Set不安全

![在这里插入图片描述](24.JUC.assets/20200727201604399.png)
...
![在这里插入图片描述](24.JUC.assets/20200727201710950.png)
...
![在这里插入图片描述](24.JUC.assets/20200727201823382.png)
...
![在这里插入图片描述](24.JUC.assets/20200727201858566.png)
...
![在这里插入图片描述](24.JUC.assets/20200727201934861.png)
...
![在这里插入图片描述](24.JUC.assets/20200727202005417.png)

FutureTask中可以接受Callable参数；

![在这里插入图片描述](24.JUC.assets/20200727202022160.png)
...
![在这里插入图片描述](24.JUC.assets/20200727202113698.png)

注意两个重点：

![在这里插入图片描述](24.JUC.assets/20200727202135656.png)

## 8、常用的辅助类(必会！)

### 8.1 CountDownLatch

![在这里插入图片描述](24.JUC.assets/20200727202247162.png)**其实就是一个减法计数器，对于计数器归零之后再进行后面的操作，这是一个计数器！**
...
![在这里插入图片描述](24.JUC.assets/20200727202349295.png)
...
![在这里插入图片描述](24.JUC.assets/20200727202624665.png)

阻塞队列jdk1.8文档解释：

![在这里插入图片描述](24.JUC.assets/20200727202645162.png)
...
![在这里插入图片描述](24.JUC.assets/20200727202709411.png)
...
![在这里插入图片描述](24.JUC.assets/20200727203110154.png)

阿里巴巴的Java操作手册中明确说明：对于Integer.MAX_VALUE初始值较大，所以一般情况我们要使用底层的**ThreadPoolExecutor**来创建线程池。

>  业务图

![在这里插入图片描述](24.JUC.assets/20200727203248928.png)
...
![在这里插入图片描述](24.JUC.assets/20200727203331940.png)

**（1）new ThreadPoolExecutor.AbortPolicy()：** //该拒绝策略为：银行满了，还有人进来，不处理这个人的，并抛出异常

超出最大承载，就会抛出异常：队列容量大小+maxPoolSize

![在这里插入图片描述](24.JUC.assets/20200727203414339.png)

**（2）new ThreadPoolExecutor.CallerRunsPolicy()：** //该拒绝策略为：哪来的去哪里 main线程进行处理

![在这里插入图片描述](24.JUC.assets/20200727203500107.png)

**（3）new ThreadPoolExecutor.DiscardPolicy():** //该拒绝策略为：队列满了,丢掉异常，不会抛出异常。

![在这里插入图片描述](24.JUC.assets/20200727203537911.png)

**（4）new ThreadPoolExecutor.DiscardOldestPolicy()：** //该拒绝策略为：队列满了，尝试去和最早的进程竞争，不会抛出异常

![在这里插入图片描述](24.JUC.assets/20200727203600323.png)
...
![在这里插入图片描述](24.JUC.assets/20200727203627960.png)

我们可以使用代码来来获取逻辑处理器数量。

于是**cpu密集型**的写法如下：

![在这里插入图片描述](24.JUC.assets/20200727203653987.png)
...
![在这里插入图片描述](24.JUC.assets/20200727203732511.png)
...
![在这里插入图片描述](24.JUC.assets/20200727203808177.png)
...
![在这里插入图片描述](24.JUC.assets/20200727203829514.png)
...
![在这里插入图片描述](24.JUC.assets/20200727203853168.png)
...
![在这里插入图片描述](24.JUC.assets/20200727203909741.png)
...
![在这里插入图片描述](24.JUC.assets/20200727203936254.png)

> **ForkJoin 特点： 工作窃取！**

实现原理是：**双端队列**！从上面和下面都可以去拿到任务进行执行！

![在这里插入图片描述](24.JUC.assets/20200727203958799.png)
...
- 2、计算任务 **execute(ForkJoinTask<?> task)**
  ...
  ![在这里插入图片描述](24.JUC.assets/20200727204016283.png)
...
![在这里插入图片描述](24.JUC.assets/20200727204101914.png)

**reduce方法的优点：**

![在这里插入图片描述](24.JUC.assets/20200727204117372.png)
...
![在这里插入图片描述](24.JUC.assets/20200727204140269.png)
...
![在这里插入图片描述](24.JUC.assets/20200727204419162.png)

![在这里插入图片描述](24.JUC.assets/2020072720443785.png)
...
![在这里插入图片描述](24.JUC.assets/2020072720445830.png)
...
![在这里插入图片描述](24.JUC.assets/20200727204535517.png)

解决方法：使用JUC下的原子包下的class；

![在这里插入图片描述](24.JUC.assets/20200727204554558.png)
...
![在这里插入图片描述](24.JUC.assets/20200727204653125.png)
...
![在这里插入图片描述](24.JUC.assets/20200727204727492.png)

枚举类型使用JAD最终反编译后源码：

如果我们看idea 的文件：会发现idea骗了我们，居然告诉我们是有有参构造的，我们使用jad进行反编译。

![在这里插入图片描述](24.JUC.assets/20200727204751957.png)

![在这里插入图片描述](24.JUC.assets/2020072720480950.png)
...
![在这里插入图片描述](24.JUC.assets/20200727214229852.png)

> Unsafe类

![在这里插入图片描述](24.JUC.assets/20200727214247117.png)



![在这里插入图片描述](24.JUC.assets/20200727214300255.png)
...
![在这里插入图片描述](24.JUC.assets/20200727214320203.png)
...
![在这里插入图片描述](24.JUC.assets/20200727214340236.png)

所以如果遇到，使用大于128的时候，**使用原子引用的时候，如果超过了这个值，那么就不会进行版本上升！**

![在这里插入图片描述](24.JUC.assets/20200727214355541.png)

那么如果我们使用小于128的时候：

![在这里插入图片描述](24.JUC.assets/2020072721441445.png)
...
![在这里插入图片描述](24.JUC.assets/20200727214440726.png)
...
![在这里插入图片描述](24.JUC.assets/20200727215218525.png)
...
![[外链图片转存中...(img-LeKLRYJj-1595850751627)]](24.JUC.assets/20200727215116557.png)

**2、使用`jstack` 进程进程号 找到死锁信息**

![[外链图片转存中...(img-kQeUM5lC-1595850751627)]](24.JUC.assets/20200727215134554.png)

**一般情况信息在最后：**

![[外链图片转存中...(img-DypkNFBU-1595850751627)]](24.JUC.assets/20200727215149832.png)